...
- `SupportedHardwareWallet.transports` now uses `HardwareWalletTransport` instead of `TrezorTransportType`; callers should migrate transport comparisons and handle the new `Qr` case.
